<#
.SYNOPSIS
This script ensures that the Application Compatibility Program Inventory is prevented from collecting data and sending the information to Microsoft.
...
.USAGE
    PS C:\> .\Remediation_WN10-CC-000175.ps1
#>
